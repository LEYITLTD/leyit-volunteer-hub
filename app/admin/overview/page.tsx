    ...
    <div className="flex-1 p-4 sm:p-6 lg:p-8 w-full">
      ...
      {loading ? (
        ...
        <>
          ...
          {/* Total volunteers bar */}
          <div
            className="rounded-xl border px-5 py-3.5 flex items-center justify-between gap-4 mb-7"
          ...
          <div className="rounded-xl border overflow-hidden" style={{ background: "var(--color-card)", borderColor: "var(--color-card-border)" }}>
            <div className="px-5 py-4 border-b" style={{ borderColor: "var(--color-card-border)" }}>
              <h2 className="text-[13px] font-semibold" style={{ color: "var(--color-text-primary)" }}>Activity log</h2>
              <p className="text-[11px] mt-0.5" style={{ color: "var(--color-text-muted)" }}>
                Recent sign-ups, confirmations and events
              </p>
            </div>
                ...
                {data.activity.map((item, i) => {
                  ...
                  return (
                    <div key={item.id} className="flex items-center gap-3.5 px-5 py-3.5">
                      ...
                      {/* Time */}
                      <span className="text-[11px] flex-shrink-0 tabular-nums" style={{ color: "var(--color-text-muted)" }}>
